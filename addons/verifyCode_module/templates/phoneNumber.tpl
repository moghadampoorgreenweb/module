    ...
    <div class="card mw-540 mb-md-4 mt-md-4">
        <div class="card-body px-sm-5 py-5"><h3 for="number" class="form-control-label">Login Form</h3>
            ...
            <div class="form-group">
                <label for="number" class="form-control-label">Enter Your Phone Number:</label>
            ...
            <div class="float-left">     <input type="submit" value="send code" class="form-control btn-info btn">
            </div>
        </div>
